...
; *** Variable Definition ***
; Array variables
array_address   EQU 0x20    ; array address
array_length    EQU 0x21    ; array length
...
statistics
    ...
    clrf    array_sum_high      ; initialize with 0
...
avg ; Loop while division counter is bigger than 1
    rrf     array_sum_high, F   ; Divide by 2 array_sum
    rrf     array_sum_low, F

    ; If there are remaining division restart loop
    bcf     STATUS, C
    rrf     divisions_counter, F
    decfsz  divisions_counter, W
    goto    avg ; restart loop
...
statistics_loop
    ...
    btfsc   STATUS, C
    return  ; break out of loop if conditions are not satisfied
